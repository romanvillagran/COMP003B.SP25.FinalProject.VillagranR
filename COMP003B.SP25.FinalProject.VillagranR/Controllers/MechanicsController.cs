...
namespace COMP003B.SP25.FinalProject.VillagranR.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Specialty,YearsExperience,Phone,Email")] Mechanic mechanic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Specialty,YearsExperience,Phone,Email")] Mechanic mechanic)
        {
            if (id != mechanic.Id)
            {
                return NotFound();
